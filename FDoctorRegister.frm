...
Begin VB.Form FDoctorRegister 
   ...
   ClientWidth     =   9930
   ControlBox      =   0   'False
   Icon            =   "FDoctorRegister.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "FDoctorRegister.frx":000C
   ScaleHeight     =   7395
   ScaleWidth      =   9930
   ...
   Begin VB.CommandButton CClose 
      ...
      Height          =   505
      Left            =   7950
      Picture         =   "FDoctorRegister.frx":1FEC4E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   6780
      Width           =   1365
   ...
   Begin VB.CommandButton CSave 
      Height          =   505
      Left            =   6495
      Picture         =   "FDoctorRegister.frx":2010B0
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   6780
      Width           =   1365
   End
   Begin VB.CommandButton CDeleteDoctor 
      Height          =   505
      Left            =   2055
      Picture         =   "FDoctorRegister.frx":203512
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   6780
      Width           =   1365
   ...
   Begin VB.CommandButton CAddNew 
      Height          =   505
      Left            =   630
      Picture         =   "FDoctorRegister.frx":205974
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   6780
      Width           =   1365
