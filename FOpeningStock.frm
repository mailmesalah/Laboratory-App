...
Begin VB.Form FOpeningStock 
   ...
   Begin VB.CommandButton CSave 
      Height          =   505
      Left            =   11550
      Picture         =   "FOpeningStock.frx":2462
      Style           =   1  'Graphical
      TabIndex        =   16
      Top             =   8580
      Width           =   1365
   ...
   Begin VB.CommandButton CClose 
      ...
      Height          =   505
      Left            =   12990
      Picture         =   "FOpeningStock.frx":48C4
      Style           =   1  'Graphical
      TabIndex        =   19
      Top             =   8580
      Width           =   1365
   ...
   Begin VB.CommandButton CAddItem 
      Height          =   505
      Left            =   255
      Picture         =   "FOpeningStock.frx":6D26
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   7455
      Width           =   1365
   ...
   Begin VB.CommandButton CRemoveItem 
      Height          =   505
      Left            =   1695
      Picture         =   "FOpeningStock.frx":9188
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   7455
      Width           =   1365
   ...
   Begin VB.CommandButton CClear 
      Height          =   505
      Left            =   3135
      Picture         =   "FOpeningStock.frx":B5EA
      Style           =   1  'Graphical
      TabIndex        =   15
      Top             =   7455
      Width           =   1365
   ...
   Begin VB.CommandButton CDelete 
      Height          =   505
      Left            =   4950
      Picture         =   "FOpeningStock.frx":DA4C
      Style           =   1  'Graphical
      TabIndex        =   18
      Top             =   135
      Width           =   1365
   ...
   Begin MSForms.Label Label2 
      ...
      BackColor       =   15724527
      Size            =   "26326;926"
      Picture         =   "FOpeningStock.frx":FEAE
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
   End
...
Dim gSerialNo As Single, gItem As Single, gQuantity As Single, gUnit As Single, gPurchaseRate As Single, gMRP As Single, gRetail As Single, gWholeSale As Single, gOther As Single, gTotalAmount As Single, gBillingName As Single, gItemCode As Single, gUnitValue As Single, gGrossValue As Single, gTaxAmount As Single, gBarCode As Single
...
Dim rs As Recordset, sTransactionNo As String
    ...
    Set rs = db.OpenRecordset("Select Max(Val( Transaction.BillNo)) As TNo From Transaction Where ( Transaction.BillType = 'O' )")
...
Dim rs As Recordset, lYN As Long, bFound As Boolean
    ...
    If (MsgBox("Do you want to Delete the Bill ?", vbDefaultButton2 Or vbYesNo) = vbYes) Then
        Set rs = db.OpenRecordset("Select Transaction.* From Transaction Where (Transaction.BillNo = '" & Trim(TTransactionNo.Text) & "' ) And (Transaction.BillType = 'O' )")
        While rs.EOF = False
            bFound = True
            rs.Delete
            rs.MoveNext
...
Private Sub getTotal()
    ...
    LTaxAmount = Val(LGross.Caption) * Val(0) / 100
